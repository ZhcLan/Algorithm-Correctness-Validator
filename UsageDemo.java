...
public class UsageDemo {
    public static IntegerPlus[] selectionSort(IntegerPlus[] arr) {
    ...
    // for test!
    public static IntegerPlus[] insertionSort(IntegerPlus[] arr) {
        if (arr == null || arr.length < 2) {
            return arr;
        }
     ...
     *
     * Fate - specifies some special values (range and number of occurrences)
     * <p>
     * <br/>
     * <p>
    ...
    public static void main(String[] args) {
        ...
        ValidatorConfig config = new ValidatorConfig(5000, UsageDemo.class, "selectionSort",
                "insertionSort");
        Argument arguments = new Argument(
                ...
                new Range[]{new Range(100, 200), new Range(-1, -1)},
                ...
                new Range[]{new Range(-1, -1), new Range(-10000, 10000)}
        );
        // startup!
    ...
    /*
     * Some cases:
     * You can specify special values for the interface under the Collection in Range
     * (using objects that are members of the Fate class of the Range), as shown in the following parameters
     *
     * You can pass in any arguments, but don't be too complicated,
     * although most of the arguments can be parsed, but this is a risky behavior
     */
